...
public class Main{
	...
	public Main(String insuredCode, String checkType, String checkFlag,
			String policyNo, String reportNo, String insuredName,
			String insuredAddress, String identifyType, String identifyNumber,
			String phoneNumber, String farmerType, String isPoor,
			String insuredQuantity, String bank, String cardNo, String amount,
	...
	public String toString() {
		return "Main [insuredCode=" + insuredCode + ", checkType=" + checkType
				+ ", checkFlag=" + checkFlag + ", policyNo=" + policyNo
				+ ", reportNo=" + reportNo + ", insuredName=" + insuredName
				+ ", insuredAddress=" + insuredAddress + ", identifyType="
				+ identifyType + ", identifyNumber=" + identifyNumber
				+ ", phoneNumber=" + phoneNumber + ", farmerType=" + farmerType
				+ ", isPoor=" + isPoor + ", insuredQuantity=" + insuredQuantity
				+ ", bank=" + bank + ", cardNo=" + cardNo + ", amount="
				+ amount + ", premium=" + premium + ", centralAllowance="
				+ centralAllowance + ", provinceAllowance=" + provinceAllowance
				...
				+ ", compensation=" + compensation + ", compensationQuantity="
